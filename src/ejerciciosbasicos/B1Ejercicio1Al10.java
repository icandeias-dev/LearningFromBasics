...
public abstract class B1Ejercicio1Al10 {
    ...
    public static void ej1(Scanner sn) {
        ...
        if (discriminante >= 0) { //Evitamos hacer cálculos innecersarios si el discrimiantete es negativo
    ...
    public static void ej9(Scanner sn) {
        ...
        System.out.print("Ordenados de mayor a menor quedan así: ");
        for (int i : al) {
    ...
    public static void ej10(Scanner sn) {
        ...
        final String[] orden = {"primer", "segundo", "tercer"};
        ...
        if (numeros[primerNum] >= numeros[segundoNum] && numeros[primerNum] >= numeros[tercerNum]) { // Teniendo en cuenta que el primer numero sea el mayor
            ...
            //// Teniendo en cuenta que el tercer numero sea el mayor
